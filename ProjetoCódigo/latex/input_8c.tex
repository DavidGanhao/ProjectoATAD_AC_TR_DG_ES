...
Bruno Silva (\href{mailto:bruno.silva@estsetubal.ips.pt}{\texttt{ bruno.\+silva@estsetubal.\+ips.\+pt}}) Relies in always reading text and converting to the appropriate data type. Some straighforward validations are implemented. Does not allow trailing spaces in the formats.
\end{DoxyAuthor}
...
\hline
{\em n\+Tokens} & \mbox{[}in\mbox{]} number of required tokens. If there are less tokens than specified, then N\+U\+LL is used for subsequent tokens. \\
\hline
